        ...
        if ReleasedSaltman == False:
            if saltiness == 53:
                if SpoonUpgrade:
                    ...
                    mixer.music.stop()
                    mixer.music.unload()
                    mixer.music.load("Man of Salt.wav")
                    mixer.music.play(-1)
                    print(saltman)
...
def deathbypoison():
    ...
    mixer.music.stop()
    mixer.music.unload()
    mixer.music.load("cruel soup cruel life.wav")
    mixer.music.play(-1)
...
def saltylife():
    ...
    mixer.music.stop()
    mixer.music.unload()
    mixer.music.load("Alive but salty.wav")
    mixer.music.play(-1)
...
def toosalty():
    ...
    mixer.music.stop()
    mixer.music.unload()
    mixer.music.load("Life is salty.wav")
    mixer.music.play(-1)
    mixer.Channel(1).play(mixer.Sound('dying.wav'))
                ...
                if ReleasedSoupman == False:
                    if soupiness == 5:
                        if SpoonUpgrade == True:
                            ...
                            mixer.music.stop()
                            mixer.music.unload()
                            mixer.music.load("Can you eat him with a spoon.wav")
                            mixer.music.play(-1)
                            print(soupman)
                            print("hi thank you for releasing me")
                            if ReleasedSaltman == False:
